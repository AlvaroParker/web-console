  ...
  return (
    <>
          ...
          >
            <g id="CIRCLE__x2F__STOP_1_" enableBackground="new">
              <g id="CIRCLE__x2F__STOP">
                <path
                  d="M40,21H24c-1.657,0-3,1.343-3,3v16c0,1.657,1.343,3,3,3h16c1.657,0,3-1.343,3-3V24C43,22.343,41.657,21,40,21z M32,0       C14.327,0,0,14.327,0,32s14.327,32,32,32s32-14.327,32-32S49.673,0,32,0z M32,58C17.641,58,6,46.359,6,32C6,17.641,17.641,6,32,6       c14.359,0,26,11.64,26,26C58,46.359,46.359,58,32,58z"
                />
              </g>
            </g>
          </svg>
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      ...
                      This action will stop all running containers. Are you sure you want to continue?
                      </p>
                    </div>
                  </div>
                </div>
      ...
      >
        ...
        <svg className="mt-5 animate-spin text-white fill-white" width="64" height="64" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <g id="Icon"  strokeWidth="1" fill="none" fill-rule="evenodd">
                  <g id="System" transform="translate(-240.000000, -384.000000)">
                      <g id="loading_3_line" transform="translate(240.000000, 384.000000)">
                          ...
                          <path d="M12,4 C7.58172,4 4,7.58172 4,12 C4,16.4183 7.58172,20 12,20 C16.4183,20 20,16.4183 20,12 C20,7.58172 16.4183,4 12,4 Z M2,12 C2,6.47715 6.47715,2 12,2 C17.5228,2 22,6.47715 22,12 C22,17.5228 17.5228,22 12,22 C6.47715,22 2,17.5228 2,12 Z" fill="#09244B" opacity="0.1"/>
                          <path d="M12.0001,4 C10.3541,4 8.82702,4.49602 7.55638,5.34655 C7.16795,5.60656 6.80342,5.89976 6.46691,6.22213 C6.06809,6.60418 5.43507,6.59058 5.05302,6.19176 C4.67097,5.79294 4.68457,5.15992 5.08339,4.77787 C5.50341,4.37552 5.95856,4.00939 6.44386,3.68454 C8.03342,2.62052 9.94582,2 12.0001,2 C12.5524,2 13.0001,2.44772 13.0001,3 C13.0001,3.55228 12.5524,4 12.0001,4 Z" fill="#09244B"/>
                      </g>
                  </g>
              </g>
          </svg>
