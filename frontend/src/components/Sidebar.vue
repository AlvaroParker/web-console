...
<template>
	<div class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900">
		<RouterLink to="/" class="flex items-center justify-center mt-3" href="/">
			<svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="currentColor">
		...
		<div class="flex flex-col items-center mt-3 border-t border-gray-700">
			<RouterLink to="/terminal" class="flex items-center justify-center w-12 h-12 mt-2 text-gray-200 bg-gray-700 rounded" href="/terminal">
				<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					<path d="M12 19H21M3 5L11 12L3 19"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
				</svg>
			</RouterLink>
			<RouterLink to="/" class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="/">
				<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
		...
		<a class="flex items-center justify-center w-16 h-16 mt-auto bg-gray-900 hover:bg-gray-700 hover:text-gray-300" href="#">
			<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
