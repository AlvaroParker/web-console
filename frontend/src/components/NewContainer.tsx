...
export function NewContainer() {
  ...
  const [images, setImages] =
    React.useState<ContainerImageOpt[]>(Array<ContainerImageOpt>());
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <form
        className="w-full max-w-lg bg-gray-900 rounded-xl p-10"
        onSubmit={handleSubmit}
      >
        <h1 className="text-center text-2xl mb-5 font-semibol">
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              ...
              required
              value={containerName}
              onChange={(e) => handleChangeStr(e, setContainerName)}
            />
          </div>
          <div className="w-full md:w-1/2 px-3">
            ...
            <div className="relative">
              <select
                ...
                id="grid-state"
                value={command}
                onChange={(e) => handleChangeStr(e, setCommand)}
              >
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full px-3">
            ...
            <div className="relative">
              ...
              >
                {images.map((item) => (
                  <option value={item.image_tag} key={item.image_tag}>
                    {capitalize(item.image_tag)}
                  </option>
                ))}
              </select>
              <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
          ...
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <div className="relative">
              <select
                className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                id="grid-state"
                value={networkEnabled ? "True" : "False"}
                onChange={(e) => handleChangeBool(e, setNetworkEnabled)}
              >
          ...
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <div className="relative">
              <select
                className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                id="grid-state"
                value={autoremove ? "True" : "False"}
                onChange={(e) => handleChangeBool(e, setAutoremove)}
              >
                <option>True</option>
                <option>False</option>
              </select>
        ...
        <div className="flex flex-wrap -mx-3 mb-2">
          <button
            className="w-full bg-green-400 hover:bg-green-500 text-white font-bold py-3 rounded focus:outline-none focus:shadow-outline mx-3 mt-10"
            type="button"
