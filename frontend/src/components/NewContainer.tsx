export function NewContainer() {
    return (
        <div className="flex justify-center items-center h-screen">
            <form className="w-full max-w-lg bg-gray-900 rounded-xl p-10">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        ...
                        <p className="text-gray-100 text-xs italic">Make it as long and as crazy as you'd like</p>
                    </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        <label className="block uppercase tracking-wide text-gray-300 text-xs font-bold mb-2" htmlFor="grid-zip">
                            Zip
                        </label>
